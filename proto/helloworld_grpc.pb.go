...
const (
	...
	Greeter_SayList_FullMethodName   = "/helloworld.Greeter/SayList"
	Greeter_SayRecord_FullMethodName = "/helloworld.Greeter/SayRecord"
	Greeter_SayRoute_FullMethodName  = "/helloworld.Greeter/SayRoute"
)
...
func (c *greeterClient) SayList(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_SayListClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], Greeter_SayList_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayRecord(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayRecordClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[1], Greeter_SayRecord_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayRoute(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayRouteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[2], Greeter_SayRoute_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
